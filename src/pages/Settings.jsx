...
const Settings = () => {
  return (
    <div className="pb-32 sm:pb-12">
          ...
          <section className="bg-surface-container-lowest p-6 sm:p-10 rounded-[2rem] border border-outline-variant/15 shadow-sm hover:shadow-lg transition-transform hover:-translate-y-1">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <span className="text-xs font-bold uppercase tracking-widest text-secondary">Sincronização Ativa</span>
              </div>
            </div>
            
            <div className="space-y-6">
              <div className="group">
                <label className="block text-xs font-black uppercase text-on-surface-variant mb-2 tracking-wider ml-1">Chave da API</label>
              ...
              <div>
                <label className="block text-xs font-black uppercase text-on-surface-variant mb-2 tracking-wider ml-1">Número de Telefone</label>
              ...
              <div className="pt-2">
                <button className="w-full sm:w-auto h-12 flex items-center justify-center gap-3 bg-primary/10 text-primary font-black uppercase text-xs tracking-widest px-8 rounded-full hover:bg-primary transition-all hover:text-white active:scale-95 shadow-sm">
          ...
          <section className="bg-surface-container-lowest p-6 sm:p-10 rounded-[2rem] border border-outline-variant/15 shadow-sm flex flex-col">
            ...
            <div className="space-y-7 flex-1">
              {[
                ...
                <div key={idx} className="flex items-center justify-between group active:scale-[0.98] transition-all cursor-pointer">
                  <div className="flex-1">
                    ...
                    <p className="text-xs font-medium text-on-surface-variant opacity-60 leading-tight">{item.sub}</p>
                  </div>
              ...
              <div className="pt-8 border-t border-outline-variant/10">
                <p className="text-xs font-black uppercase text-on-surface-variant mb-4 flex items-center gap-2 opacity-50">
                  <span className="material-symbols-outlined text-sm">do_not_disturb_on</span>
                  Intervalo de Silêncio
                </p>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-xs uppercase tracking-widest font-black text-on-surface-variant/40 mb-1.5 block ml-1">Início</label>
                  ...
                  <div>
                    <label className="text-xs uppercase tracking-widest font-black text-on-surface-variant/40 mb-1.5 block ml-1">Fim</label>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <span className="text-xs font-bold uppercase tracking-widest text-on-surface-variant/30 italic">Administrador do Sistema</span>
                </div>
              </div>
              <div className="flex -space-x-3 hover:space-x-1 transition-all">
                ...
                <div className="w-10 h-10 rounded-full border-2 border-surface bg-primary/10 flex items-center justify-center text-primary font-black text-xs cursor-pointer">+3</div>
              </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-1 px-1">
                <label className="block text-xs font-black uppercase text-on-surface-variant mb-1 ml-1 tracking-wider opacity-60">Nome Completo</label>
              ...
              <div className="space-y-1 px-1">
                <label className="block text-xs font-black uppercase text-on-surface-variant mb-1 ml-1 tracking-wider opacity-60">E-mail de Acesso</label>
      ...
      <div className="md:hidden fixed bottom-[calc(var(--bottom-nav-h)+env(safe-area-inset-bottom))] left-0 right-0 p-4 bg-gradient-to-t from-surface to-transparent pointer-events-none pb-12">
